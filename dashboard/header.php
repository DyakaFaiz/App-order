...
<body>
  ...
  $htm = 'text-dark';
  ?>
  <nav class="navbar navbar-expand-lg p-3" style="background-color: <?= $color ?>;">
    <div class="container">
      <img src="assets/image/logo.jpg" class="wrap-pic-cir shadow pter" alt="" width="50" height="50" class="mb-1">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <?php elseif ($level == "Pelanggan" || $level == "") : ?>
            <a class="nav-link ml-3 fs-5 <?= $home ?>" href="index.php">Home <span class="sr-only">(current)</span></a>
        ...
        <ul class="navbar-nav ml-auto">
          <?php if ($_SESSION['level'] == "") : ?>
            <a href="../auth/index.php" class="nav-item btn mr-2 text-white abu" style="background-color: #b94d05;">Login</a>
          <?php else : ?>
          ...
          <?php if ($_SESSION['level'] != "Owner") : ?>
            <li class="nav-item dropdown">
              <a class="nav-link" data-toggle="modal" data-target=".bd-example-modal-xl">
                <i class="fa fa-shopping-cart mr-1 hov-pointer"></i>
              </a>
