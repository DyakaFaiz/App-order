        ...
        <div class="col-md-12">
            <div class="col-12 p-4">
                <div class="row flex-nowrap overflow-auto">
                    ...
                    <?php
                    $query = "SELECT * FROM tb_masakan WHERE kategori_masakan='Dessert' ORDER BY id_masakan";
                                        ...
                                        <div class="modal-body mt-2 p-4">
                                            <div class="row">
                                                <div class="col-sm-7 flex-c">
                                                    <img src="assets/image/Dessert/<?= $data['foto'] ?>" alt="" style="" class="card-img shadow p-2">
                                                </div>
                                                <div class="col-sm-5">
                                                    ...
                                                    <div class="form-group row shadow-sm rounded p-2">
                                                        ...
                                                        <span style="text-transform: capitalize;"><?= $data['nama_masakan'] ?></span>
                                                    </div>
                                                    <div class="form-group row shadow-sm rounded p-2">
