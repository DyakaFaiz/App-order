    ...
    <div class="row p-3">
        ...
        <div class="col-md-12">
            <div class="row p-1">
                ...
                <?php
                $query = "SELECT * FROM tb_masakan WHERE kategori_masakan='dessert' ORDER BY id_masakan LIMIT 4";
                $sql = mysqli_query($kon, $query);
                while ($data = mysqli_fetch_array($sql)) :
                ?>
                    <div class="col-lg-2 mb-1">
                        <div class="card shadow p-3 mb-2 bg-white">
                            <img class="card-img-top shadow mb-4 bg-white rounded" height="125" src="assets/image/dessert/<?= $data['foto'] ?>" alt="Card image cap">
                            <div class="card-body">
                                <div class="mb-1">
                            ...
                            <div class="modal-content">
                                ...
                                <form action="fungsi/orderMakanan.php" method="POST">
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <img src="assets/image/Dessert/<?= $data['foto'] ?>" alt="" class="card-img-top">
                                            </div>
                                            <div class="col-md-6">
