...
if ($q_validasi > 0) {
    ...
    $hartot2 = $duplikat * $hartot;
    $query_tambah_duplikat = mysqli_query($kon, "UPDATE tb_detail_order SET jumlah_dorder='$duplikat', hartot_dorder='$hartot2' WHERE id_masakan='$id_masakan' AND check_available = '$no_order'");
