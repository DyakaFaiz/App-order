              ...
              <table class="table table-responsive-sm" border="0">
                ...
                <tbody>
                  ...
                  foreach ($list_pesanan as $pesanan) :
                    ...
                    $mskn = mysqli_query($kon, "SELECT * FROM tb_masakan WHERE nama_masakan");
                    $ketOrder = mysqli_query($kon, "SELECT * FROM tb_detail_order WHERE keterangan_dorder");
                    $jmlOrder = mysqli_query($kon, "SELECT * FROM tb_detail_order WHERE jumlah_dorder");
                    $hrg = mysqli_query($kon, "SELECT * FROM tb_masakan WHERE harga_masakan");
                  ?>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><?= $mskn ?></td>
